...
public class DeletePostServlet extends HttpServlet {
    ...
    private final String OWN_POST_PAGE = "ShowOwnPostServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            cDAO.deleteAllPostComment(postID);
            eDAO.deleteAllPostEmotion(postID);
            aDAO.deletePost(postID);
            
        } catch (SQLException ex) {
            log("DeletePostServlet_SQL_" + ex.getMessage());
        } catch (NamingException ex) {
            log("DeletePostServlet_Naming_" + ex.getMessage());
        } finally {
